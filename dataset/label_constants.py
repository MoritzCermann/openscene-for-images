...
CUSTOM_LABELS_160 = (
    'tree', 'bush', 'grass', 'flower', 'rock', 'mountain', 'hill', 'cliff', 'forest', 'river', 
    'lake', 'waterfall', 'stream', 'ocean', 'beach', 'sand', 'desert', 'meadow', 'field', 'swamp', 
    'cave', 'ice', 'snow', 'glacier', 'volcano', 'cloud', 'sun', 'moon', 'sky', 'rainbow',
    'bird', 'deer', 'dog', 'cat', 'cow', 'sheep', 'horse', 'goat', 'fish', 'duck', 
    'swan', 'butterfly', 'insect', 'rabbit', 'squirrel', 'fox', 'bear', 'wolf', 'turtle', 'snake',
    'road', 'path', 'trail', 'bridge', 'tunnel', 'highway', 'sidewalk', 'crosswalk', 'railway', 'train station',
    'parking lot', 'building', 'skyscraper', 'house', 'hut', 'barn', 'windmill', 'water tower', 'fence', 'gate',
    'dam', 'canal', 'pier', 'dock', 'harbor', 'power line', 'wind turbine', 'solar panel', 'light pole', 'traffic light',
    'car', 'truck', 'bus', 'motorcycle', 'bicycle', 'train', 'airplane', 'helicopter', 'boat', 'ship', 
    'kayak', 'canoe', 'jet ski', 'sailboat', 'tractor', 'trailer', 'van', 'ambulance', 'firetruck', 'police car',
    'statue', 'monument', 'fountain', 'bench', 'street lamp', 'mailbox', 'trash can', 'traffic sign', 'billboard', 'telephone booth',
    'clock tower', 'market stall', 'bus stop', 'garden', 'playground', 'park bench', 'water fountain', 'kiosk', 'metro entrance', 'street vendor',
    'stadium', 'tennis court', 'soccer field', 'basketball court', 'swimming pool', 'golf course', 'ski slope', 'skate park', 'campfire', 'tent',
    'picnic table', 'barbecue grill', 'boat dock', 'amusement park', 'carousel', 'roller coaster', 'hiking trail', 'viewpoint', 'fishing pier', 'climbing wall',
    'person', 'bicycle rider', 'hiker', 'runner', 'skater', 'fisherman', 'tourist', 'child', 'dog walker', 'gardener',
    'umbrella', 'hat', 'backpack', 'camera', 'binoculars', 'map', 'walking stick', 'chair', 'table', 'tent',
    'rain', 'fog', 'smoke', 'lightning', 'star', 'shadow', 'sunbeam', 'reflection', 'campfire light', 'firework',
    'drone', 'kite', 'hot air balloon', 'flag', 'signpost', 'sculpture', 'art installation', 'treehouse', 'fountain statue', 'birdhouse'
)

CUSTOM_LABELS_18 = (
    'tree', 'bush', 'grass', 'road', 'roundabout', 'roof', 'solar', 'car', 'parking', 'window', 
    'billboard', 'truck', 'trafficsign', 'housewall', 'manholecover', 'stairs', 'garage'
)
